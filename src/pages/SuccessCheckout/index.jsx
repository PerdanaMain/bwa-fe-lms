  ...
  return (
    <div className="relative flex flex-col flex-1 p-[10px]">
      ...
      <Link to="/manager/sign-in">
        <div className="flex items-center justify-center mx-auto mt-5 gap-3 w-max rounded-full border p-[20px_50px] transition-all duration-300 hover:bg-[#662FFF] hover:border-[#8661EE] hover:shadow-[-10px_-6px_10px_0_#7F33FF_inset] bg-[#662FFF] border-[#8661EE] shadow-[-10px_-6px_10px_0_#7F33FF_inset]">
